import { formatISODateOnly } from "../utils/dateFormatter";
...
const appointmentEmail = (
  ...
  const cancellationLink = `http://localhost:3000/appointment/cancel/${id}`;
  ...
  return `<!-- Free to use, HTML email template designed & built by FullSphere. Learn more about us at www.fullsphere.co.uk -->
        ...
        >
          <head>
            ...
            <title>Appointment Email Invite</title>
            <!-- End title -->
            <!-- Start stylesheet -->
            <style type="text/css">
              a,
          ...
          >
              ...
              >
                ...
                <p
                  ...
                  "
                >
                  You have been invited to join the meeting Agent Meeting on
                  <b>July 1, 2022.</b> You can see the information below in this email.
                  See you there!
                </p>
                ...
                <div>
                  ...
                  <div>
                    ...
                    >
                      Fullname:
                      <span style="font-weight: 300; font-family: 'Roboto', sans-serif"
                        >${name}</span
                      >
                    </h5>
                    <h5
                    ...
                    >
                      Start Time:
                      <span style="font-weight: 300; font-family: 'Roboto', sans-serif"
                        >${formatISODateOnly(startTime)}</span
                      >
                    </h5>
                    <h5
                      style="
                    ...
                    >
                      End Time:
                      <span style="font-weight: 300; font-family: 'Roboto', sans-serif"
                        >${formatISODateOnly(endTime)}</span
                      >
                    </h5>
                    <h5
                      style="
                  ...
                  <p
                    ...
                    "
                  >
                    You can cancel this appointment by clicking this
                    <a
                      target="_blank"
