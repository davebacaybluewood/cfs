...
const Calculator: React.FC = () => {
  ...
  useEffect(() => {
    const onCalculate = (data = initialValues) => {
      ...
      const personalMonthlyTargetPremium = Number(data.personal.monthlyTargetPremium);
      ...
      const spreadMonthlyTargetPremium8 = Number(data.spread.monthlyTargetPremium8);
      ...
      const numberOfPromotedMembers8 = Number(data.spread.numberOfPromotedMembers8);
      ...
      const spreadMonthlyTargetPremium7 = Number(data.spread.monthlyTargetPremium7);
      ...
      const numberOfPromotedMembers7 = Number(data.spread.numberOfPromotedMembers7);
      ...
      const spreadMonthlyTargetPremium6 = Number(data.spread.monthlyTargetPremium6);
      ...
      const numberOfPromotedMembers6 = Number(data.spread.numberOfPromotedMembers6);
      ...
      const spreadMonthlyTargetPremium5 = Number(data.spread.monthlyTargetPremium5);
      ...
      const numberOfPromotedMembers5 = Number(data.spread.numberOfPromotedMembers5);

      /* Position 4 */
      /*Senior Marketing Director */
      const spreadNumberValue4 = Number(data.spread.position4.numberValue);
      const spreadMonthlyTargetPremium4 = Number(data.spread.monthlyTargetPremium4);
      ...
      const numberOfPromotedMembers4 = Number(data.spread.numberOfPromotedMembers4);

      /* Formula 4 */
      const spread4Calculation =
        numberOfPromotedMembers4 * spreadPremiumMember4 * spreadMonthlyTargetPremium4;
      ...
      const spreadMonthlyTargetPremium3 = Number(data.spread.monthlyTargetPremium3);
      ...
      const numberOfPromotedMembers3 = Number(data.spread.numberOfPromotedMembers3);

      /* Formula 3 */

      const spread3LessDirectMem3 = spreadNumberOfMembers3 - numberOfDirectMembers3;
      ...
      const spreadMonthlyTargetPremium2 = Number(data.spread.monthlyTargetPremium2);
      ...
      const numberOfPromotedMembers2 = Number(data.spread.numberOfPromotedMembers2);
      /* Formula 2 */

      const spread2LessDirectMem2 = spreadNumberOfMembers2 - numberOfDirectMembers2;
      ...
      const spreadMonthlyTargetPremium1 = Number(data.spread.monthlyTargetPremium1);
      ...
      const numberOfPromotedMembers1 = Number(data.spread.numberOfPromotedMembers1);

      /* Formula 1 */
      const spread1LessDirectMem1 = spreadNumberOfMembers1 - numberOfDirectMembers1;

      /** Validation */
      const isAssociate =
        data.personal.position[0].value === PROFILE_ROLES.AGENT.ROLE_ASSOCIATE.value;

      const isSeniorAssociate =
        data.personal.position[0].value === PROFILE_ROLES.AGENT.ROLE_SENIOR_ASSOCIATE.value;

      const isMarketingDirector =
        data.personal.position[0].value === PROFILE_ROLES.AGENT.ROLE_MARKETING_DIRECTOR.value;
      ...
      const isVicePresident =
        data.personal.position[0].value === PROFILE_ROLES.AGENT.ROLE_EXECUTIVE_VICE_PRESIDENT.value;
      ...
      if (isVicePresident) {
        ...
        const spreadEVPandEMDCalculation =
          (spreadNumberOfMembers2 + numberOfDirectMembers2 + numberOfPromotedMembers2) *
          spreadPremiumMember2 *
          spreadMonthlyTargetPremium2;
        ...
        const directEVPExecutiveMarketingDirector =
          numberOfDirectMembers4 * spreadPremiumMember4 * spreadMonthlyTargetPremium4;
        const directEVPExecutiveMarketingDirectorTotal = directEVPExecutiveMarketingDirector;
        const spread2 = directEVPExecutiveMarketingDirectorTotal * Number(EVP_AND_EMD_PERCENTAGE);
        /* ------- END Formula EMD */
        ...
        const directEVPSeniorMarketingDirector =
          numberOfDirectMembers4 * spreadPremiumMember4 * spreadMonthlyTargetPremium4;
        const directEVPSeniorMarketingDirectorTotal = directEVPSeniorMarketingDirector;
        const spread3 = directEVPSeniorMarketingDirectorTotal * Number(EVP_AND_SMD_PERCENTAGE);
        /* ------- END Formula SMD */

        /** ------ MD */
        // Formula MD
        const directEVPMarketingDirector =
          numberOfDirectMembers5 * spreadPremiumMember5 * spreadMonthlyTargetPremium5;
        const directEVPMarketingDirectorTotal = directEVPMarketingDirector;
        const spread4 = directEVPMarketingDirectorTotal * Number(EVP_AND_MD_PERCENTAGE);
        /* ------- END Formula MD */

        /** ------ Senior Associate */
        // Formula Senior Associate
        const directEVPSeniorAssociate =
          numberOfDirectMembers6 * spreadPremiumMember6 * spreadMonthlyTargetPremium6;
        const directEVPSeniorAssociateTotal = directEVPSeniorAssociate;
        const spread5 = directEVPSeniorAssociateTotal * Number(EVP_AND_SA_PERCENTAGE);
        /* ------- END Formula Senior Associate */

        /** ------ Associate */
        // Formula Associate
        const directEVPAssociate =
          numberOfDirectMembers7 * spreadPremiumMember7 * spreadMonthlyTargetPremium7;
        ...
        const directEVPTrainingAssociate =
          numberOfDirectMembers8 * spreadPremiumMember8 * spreadMonthlyTargetPremium8;
        const directEVPTrainingAssociateTotal = directEVPTrainingAssociate;
        const spread7 = directEVPTrainingAssociateTotal * Number(EVP_AND_TA_PERCENTAGE);
        /* ------- END Formula TrainingAssociate */

        SPREAD_TOTAL = spread1 + spread2 + spread3 + spread4 + spread5 + spread6 + spread7;
        ...
        const spreadSEMDandEMDCalculation =
          (spreadNumberOfMembers3 + numberOfDirectMembers3 + numberOfPromotedMembers3) *
          spreadPremiumMember3 *
          spreadMonthlyTargetPremium3;
        ...
        const directSEMDSeniorMarketingDirector =
          numberOfDirectMembers4 * spreadPremiumMember4 * spreadMonthlyTargetPremium4;
        const directSEMDSeniorMarketingDirectorTotal = directSEMDSeniorMarketingDirector;
        const spread2 = directSEMDSeniorMarketingDirectorTotal * Number(SEMD_AND_SMD_PERCENTAGE);
        /* ------- END Formula SMD */
        ...
        const spread3 = directSEMDMarketingDirectorTotal * Number(SEMD_AND_MD_PERCENTAGE);
        /* ------- END Formula MD */
        ...
        const spread4 = directSEMDSeniorAssociateTotal * Number(SEMD_AND_SA_PERCENTAGE);
        /* ------- END Formula Senior Associate */
        ...
        const spread6 = directSEMDTrainingAssociateTotal * Number(SEMD_AND_TA_PERCENTAGE);
        /* ------- END Formula TrainingAssociate */
        ...
        const spreadEMDandSMDCalculation =
          (spreadNumberOfMembers4 + numberOfDirectMembers4 + numberOfPromotedMembers4) *
          spreadPremiumMember4 *
          spreadMonthlyTargetPremium4;
        ...
        const spread2 = directEMDMarketingDirectorTotal * Number(EMD_AND_MD_PERCENTAGE);
        /* ------- END Formula MD */
        ...
        const spread3 = directEMDSeniorAssociateTotal * Number(EMD_AND_SA_PERCENTAGE);
        /* ------- END Formula Senior Associate */
        ...
        const spread5 = directEMDTrainingAssociateTotal * Number(EMD_AND_TA_PERCENTAGE);
        /* ------- END Formula TrainingAssociate */
        ...
        const spreadSMDandMDCalculation =
          (spreadNumberOfMembers5 + numberOfDirectMembers5 + numberOfPromotedMembers5) *
          spreadPremiumMember5 *
          spreadMonthlyTargetPremium5;
        ...
        const spread1 =
          (spreadSMDandTATotal + spreadSMDandATotal + spreadSMDandMDTotal + spreadSMDandSATotal) *
        ...
        const spread2 = directSMDSeniorAssociateTotal * Number(SMD_AND_SA_PERCENTAGE);
        /* ------- END Formula Senior Associate */
        ...
        const spread4 = directSMDTrainingAssociateTotal * Number(SMD_AND_TA_PERCENTAGE);
        /* ------- END Formula TrainingAssociate */
        ...
        const spreadMDandSACalculation =
          (spreadNumberOfMembers6 + numberOfDirectMembers6 + numberOfPromotedMembers6) *
          spreadPremiumMember6 *
          spreadMonthlyTargetPremium6;
        ...
        const spread3 = directMDTrainingAssociateTotal * Number(MD_AND_TA_PERCENTAGE);
        /* ------- END Formula TrainingAssociate */
        ...
        const spreadSAandACalculation =
          (spreadNumberOfMembers7 + numberOfDirectMembers7 + numberOfPromotedMembers7) *
          spreadPremiumMember7 *
          spreadMonthlyTargetPremium7;
        ...
        const spread1 = (spreadSAandATotal + spreadSAandTATotal) * Number(SA_AND_A_PERCENTAGE);
        ...
        const spread2 = directSATrainingAssociateTotal * Number(SA_AND_TA_PERCENTAGE);
        /* ------- END Formula TrainingAssociate */
        ...
        const spreadAandTACalculation =
          (spreadNumberOfMembers8 + numberOfDirectMembers8 + numberOfPromotedMembers8) *
          spreadPremiumMember8 *
          spreadMonthlyTargetPremium8;
      ...
      /* Validation */
      const SAvalidity = Number(spreadNumberOfMembers7) + Number(numberOfDirectMembers7);
      const MDvalidity =
      ...
      const genTotalVol1 =
        // Formula Associate
        isAssociate
          ? numberOfPromotedMembers7 * spreadMonthlyTargetPremium7 * spreadPremiumMember7 +
            (spreadNumberOfMembers8 + numberOfDirectMembers8) *
              spreadMonthlyTargetPremium8 *
              spreadPremiumMember8
          : // Formula SA
          isSeniorAssociate
          ? numberOfPromotedMembers6 * spreadMonthlyTargetPremium6 * spreadPremiumMember6 +
            (spreadNumberOfMembers7 + numberOfDirectMembers7) *
              spreadMonthlyTargetPremium7 *
              spreadPremiumMember7
          : // Formula MD
          isMarketingDirector
          ? numberOfPromotedMembers5 * spreadMonthlyTargetPremium5 * spreadPremiumMember5 +
            (spreadNumberOfMembers6 + numberOfDirectMembers6) *
              spreadMonthlyTargetPremium6 *
              spreadPremiumMember6 +
            numberOfDirectMembers7 * spreadMonthlyTargetPremium7 * spreadPremiumMember7 +
            numberOfDirectMembers8 * spreadMonthlyTargetPremium8 * spreadPremiumMember8
          : // Formula SMD
          isSeniorMarketingDirector
          ? numberOfPromotedMembers4 * spreadMonthlyTargetPremium4 * spreadPremiumMember4 +
            (spreadNumberOfMembers5 + numberOfDirectMembers5) *
              spreadMonthlyTargetPremium5 *
              spreadPremiumMember5 +
            numberOfDirectMembers6 * spreadMonthlyTargetPremium6 * spreadPremiumMember6 +
            numberOfDirectMembers7 * spreadMonthlyTargetPremium7 * spreadPremiumMember7 +
            numberOfDirectMembers8 * spreadMonthlyTargetPremium8 * spreadPremiumMember8
          : // Formula EMD
          isExecutiveMarketingDirector
          ? numberOfPromotedMembers3 * spreadMonthlyTargetPremium3 * spreadPremiumMember3 +
            (spreadNumberOfMembers4 + numberOfDirectMembers4) *
              spreadMonthlyTargetPremium4 *
              spreadPremiumMember4 +
            numberOfDirectMembers5 * spreadMonthlyTargetPremium5 * spreadPremiumMember5 +
            numberOfDirectMembers6 * spreadMonthlyTargetPremium6 * spreadPremiumMember6 +
            numberOfDirectMembers7 * spreadMonthlyTargetPremium7 * spreadPremiumMember7
          : // Formula SEMD
          isSeniorExecutiveMarketingDirector
          ? numberOfPromotedMembers2 * spreadMonthlyTargetPremium2 * spreadPremiumMember2 +
            (spreadNumberOfMembers3 + numberOfDirectMembers3) *
              spreadMonthlyTargetPremium3 *
              spreadPremiumMember3 +
            numberOfDirectMembers4 * spreadMonthlyTargetPremium4 * spreadPremiumMember4 +
            numberOfDirectMembers5 * spreadMonthlyTargetPremium5 * spreadPremiumMember5 +
            numberOfDirectMembers6 * spreadMonthlyTargetPremium6 * spreadPremiumMember6 +
            numberOfDirectMembers7 * spreadMonthlyTargetPremium7 * spreadPremiumMember7
          : // Formula EVP
          isVicePresident
          ? numberOfPromotedMembers1 * spreadMonthlyTargetPremium1 * spreadPremiumMember1 +
            (spreadNumberOfMembers2 + numberOfDirectMembers2) *
              spreadMonthlyTargetPremium2 *
              spreadPremiumMember2 +
            numberOfDirectMembers3 * spreadMonthlyTargetPremium3 * spreadPremiumMember3 +
            numberOfDirectMembers4 * spreadMonthlyTargetPremium4 * spreadPremiumMember4 +
            numberOfDirectMembers5 * spreadMonthlyTargetPremium5 * spreadPremiumMember5 +
            numberOfDirectMembers6 * spreadMonthlyTargetPremium6 * spreadPremiumMember6 +
            numberOfDirectMembers7 * spreadMonthlyTargetPremium7 * spreadPremiumMember7
      ...
      const genTotalVol2 =
        // Formula 2 SA
        isSeniorAssociate
          ? spreadNumberOfMembers8 * spreadMonthlyTargetPremium8 * spreadPremiumMember8 +
            numberOfPromotedMembers7 * spreadMonthlyTargetPremium7 * spreadPremiumMember7
          : // Formula 2 MD
          isMarketingDirector
          ? spreadNumberOfMembers7 * spreadMonthlyTargetPremium7 * spreadPremiumMember7 +
            numberOfPromotedMembers6 * spreadMonthlyTargetPremium6 * spreadPremiumMember6
          : // Formula 2 SMD
          isSeniorMarketingDirector
          ? spreadNumberOfMembers6 * spreadMonthlyTargetPremium6 * spreadPremiumMember6 +
            numberOfPromotedMembers5 * spreadMonthlyTargetPremium5 * spreadPremiumMember5
          : // Formula 2 EMD
          isExecutiveMarketingDirector
          ? spreadNumberOfMembers5 * spreadMonthlyTargetPremium5 * spreadPremiumMember5 +
            numberOfPromotedMembers4 * spreadMonthlyTargetPremium4 * spreadPremiumMember4
          : // Formula 2 SEMD
          isSeniorExecutiveMarketingDirector
          ? spreadNumberOfMembers4 * spreadMonthlyTargetPremium4 * spreadPremiumMember4 +
            numberOfPromotedMembers3 * spreadMonthlyTargetPremium3 * spreadPremiumMember3
          : // Formula 2 EVP
          isVicePresident
          ? spreadNumberOfMembers3 * spreadMonthlyTargetPremium3 * spreadPremiumMember3 +
            numberOfPromotedMembers2 * spreadMonthlyTargetPremium2 * spreadPremiumMember2
          : 0;
      ...
      if (isSeniorAssociate && SAvalidity < 3) {
        setErrorMessage("Minimum requirement for Senior Associate not met : 3 Associates.");
                        ...
                        <Grid container spacing={2}>
                          <Grid item xs={12} md={12} lg={6}>
                            <div className="form-left-col-personal">
                              <label className="personal-label">Personal Position</label>
                              <Select
                                  ...
                                  setInitialValues((prevState): any => {
                                    return {
                                      ...
                                      personal: {
                                        ...
                                        monthlyTargetPremium:
                                          prevState.personal.monthlyTargetPremium,
                                      },
                                    };
                                  });
                                }}
                              ...
                              />
                              <ErrorText
                                isError={!values.personal.position && !!touched.personal?.position}
                                  ...
                                  setInitialValues((prevState): any => {
                                    return {
                                      ...
                                      personal: {
                                        position: [
                                          {
                                            label: prevState?.personal.position[0].label,
                                            numberValue:
                                              prevState?.personal.position[0].numberValue,
                                            value: prevState?.personal.position[0].value,
                                          },
                                        ],
                      ...
                      <div className="calculator-input-container-spread">
                        ...
                        {errorMessage ? (
                          <div className="alert-message">
                            <AlertMessage message={errorMessage} icon={<AiOutlineWarning />} />
                          </div>
                        ) : (
                          <div style={{ height: "1.5vh" }}></div>
                        )}
                        {values.personal.position[0].numberValue === AGENT_ROLES[7].numberValue ? (
                          <h2
                            style={{
                              color: "#000",
                              fontWeight: "300",
                        ...
                        <Grid container spacing={2} alignItems="center">
                          {AGENT_ROLES.map((data, index) => {
                            ...
                            if (
                              values.personal.position[0].numberValue < data.numberValue ||
                              values.personal.position[0].numberValue === AGENT_ROLES[7].numberValue
                            ) {
                              ...
                              <React.Fragment>
                                  ...
                                  <div className="perosonal-tooltip">
                                    ...
                                    >
                                      <Grid item xs={12} md={12} lg={10}>
                                        <h3 style={{ textAlign: "left" }}>{data.label}</h3>
                                      </Grid>
                                    </Grid>
                                  </div>
                                </Grid>
                                ...
                                <Grid item xs={12} md={12} lg={2}>
                                  <FormikTextInput
                                    ...
                                    value={
                                      values.spread[`numberOfMembers${sumIndex}`] === 0
                                        ? ""
                                        : values.spread[`numberOfMembers${sumIndex}`]
                                    }
                                    placeholder="0"
                                    variant="outlined"
                                    label=""
                                    ...
                                    onBlur={(e) => {
                                      setInitialValues((prevState) => {
                                        return {
                                          ...
                                          spread: {
                                            ...prevState.spread,
                                            [`numberOfMembers${sumIndex}`]: e.target?.value,
                                          },
                                        };
                                      });
                                    }}
                                ...
                                <Grid item xs={12} md={12} lg={2}>
                                  <FormikTextInput
                                    ...
                                    value={
                                      values.spread[`spread.numberOfDirectMembers${sumIndex}`] === 0
                                        ? ""
                                        : values.spread[`spread.numberOfDirectMembers${sumIndex}`]
                                    }
                                    placeholder="0"
                                    variant="outlined"
                                    label=""
                                    ...
                                    onBlur={(e) => {
                                      setInitialValues((prevState) => {
                                        return {
                                          ...
                                          spread: {
                                            ...prevState.spread,
                                            [`numberOfDirectMembers${sumIndex}`]: e.target?.value,
                                          },
                                        };
                                      });
                                    }}
                                ...
                                <Grid item xs={12} md={12} lg={2}>
                                  <FormikTextInput
                                    ...
                                    value={
                                      values.spread[`spread.numberOfPromotedMembers${sumIndex}`] ===
                                      0
                                        ? ""
                                        : values.spread[`spread.numberOfPromotedMembers${sumIndex}`]
                                    }
                                    ...
                                    onBlur={(e) => {
                                      setInitialValues((prevState) => {
                                        return {
                                          ...
                                          spread: {
                                            ...prevState.spread,
                                            [`numberOfPromotedMembers${sumIndex}`]: e.target?.value,
                                          },
                                        };
                                      });
                                    }}
                                ...
                                <Grid item xs={12} md={12} lg={2}>
                                  <FormikTextInput
                                    ...
                                    value={
                                      values.spread[`spread.numberOfPremiumMembers${sumIndex}`] ===
                                      0
                                        ? ""
                                        : values.spread[`spread.numberOfPremiumMembers${sumIndex}`]
                                    }
                                    ...
                                    onBlur={(e) => {
                                      setInitialValues((prevState) => {
                                        return {
                                          ...
                                          spread: {
                                            ...prevState.spread,
                                            [`numberOfPremiumMembers${sumIndex}`]: e.target?.value,
                                          },
                                        };
                                      });
                                    }}
                                ...
                                <Grid item xs={12} md={12} lg={2}>
                                  <FormikTextInput
                                    ...
                                    value={
                                      values.spread[`monthlyTargetPremium${sumIndex}`] === 0 || ""
                                        ? ""
                                    ...
                                    onBlur={(e) => {
                                      setInitialValues((prevState) => {
                                        return {
                                          ...
                                          spread: {
                                            ...prevState.spread,
                                            [`monthlyTargetPremium${sumIndex}`]: e.target?.value,
                                          },
                                        };
                                      });
                                    }}
                ...
                <Grid item xs={12} md={12} lg={6}>
                  <div className="right-col-calculator">
                    ...
                    <div className="calculator-input-container-override">
                      ...
                      <Grid container spacing={2} className="override-breakdown-wrapper">
                        <Grid item xs={12} md={12} lg={4}>
                          <Grid container spacing={2} className="override-earnings-label">
                            <Grid item xs={12} md={12} lg={6}>
                              <h2>Tier</h2>
                            </Grid>
                            <Grid item xs={12} md={12} lg={6}>
                              ...
                              >
                                ...
                                <Grid item xs={12} md={12} lg={6}>
                                  <h3 style={{ textAlign: "center" }}>
                                    {formatter.format(generationTotal[0][`gen${genIndex}`])}
                                  </h3>
                                </Grid>
                              </Grid>
                            );
                            ...
                            <Grid container spacing={2} justifyContent="space-between">
                              <Grid item xs={12} md={12} lg={4}>
                                <div className="tri-col-section-captions">
                                  ...
                                  <div className="earnings-value1-block">
                                    <h2>{formatter.format(totalEarnings[0].personal)}</h2>
                                  </div>
                                  <div className="earnings-label">Annual</div>
                                  <div className="earnings-value2-block">
                                    <h2 className="sky">
                                      {formatter.format(totalEarnings[0].personal * 12)}
                                    </h2>
                                  </div>
                                </div>
                              </Grid>
                              <Grid item xs={12} md={12} lg={4}>
                                <div className="tri-col-section-captions">
                                  ...
                                  <div className="earnings-label">Monthly</div>
                                  <div className="earnings-value1-block">
                                    <h2>{formatter.format(Math.round(totalEarnings[0].spread))}</h2>
                                  </div>
                                  <div className="earnings-label">Annual</div>
                                  <div className="earnings-value2-block">
                                    <h2 className="navy">
                                      {formatter.format(Math.round(totalEarnings[0].spread) * 12)}
                                    </h2>
                                  </div>
                                </div>
                              </Grid>
                              <Grid item xs={12} md={12} lg={4} style={{ position: "relative" }}>
                                <div className="tri-col-section-captions">
                                  {values.personal.position[0].numberValue < 0.81 ? (
                                    <HtmlTooltip
                                      title={
                                        ...
                                        >
                                          Potential earnings if you are Senior Marketing Director or
                                          above. Please check upline to see more details. <br />
                                          <i style={{ color: "red" }}>
                                            This earnings won't be added to your projected total
                                            earnings.
                                          </i>
                                        </div>
                                      }
                                  ...
                                  <div className="earnings-value1-block">
                                    ...
                                    >
                                      {formatter.format(totalEarnings[0].generationOverride)}
                                    </h2>
                                  </div>
                                  <div className="earnings-label">Annual</div>
                                  <div className="earnings-value2-block">
                                    ...
                                    >
                                      {formatter.format(totalEarnings[0].generationOverride * 12)}
                                    </h2>
                                  </div>
                                </div>
                              </Grid>
                  ...
                  >
                    <Box sx={style}>
                      ...
                      >
                        ...
                        >
                          The Insurance Earnings Calculator is designed for projection purposes
                          only. The results provided are based on user-inputted data and assumptions
                          and should not be considered as definitive results. Actual earnings may
                          vary.
                        </div>
                        <div
                          className="disclaimer-description"
                        ...
                        >
                          To use this calculator, enter details such as Personal position, Personal
                          monthly target premium,and details in the Spread and Generation Override
                          section. Click anywhere outside the field to get results and{" "}
                          <span
                            style={{
                              color: "#ED3E4B",
                              fontWeight: "700",
                          ...
                          >
                            <input type="checkbox" onChange={() => acknowledgeHandler()} />
                            <span style={{ marginLeft: "1rem" }}>I acknowledge this tool.</span>
                          </div>
                        </div>
                      </div>
                    </Box>
