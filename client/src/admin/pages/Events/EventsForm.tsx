...
const EventsForm: React.FC = () => {
  ...
  const headerLabel = id === "add" ? "Add Event" : "Edit Event";
  ...
  return (
    <Wrapper
      loading={
        loading || submitEventUpdate.loading || submitEventCreate.loading
      }
      breadcrumb={crumbs}
          ...
          return (
            ...
            >
              ...
              <div className="form-footer">
                <Button variant="default" onClick={backHandler}>
                  Back
                </Button>
