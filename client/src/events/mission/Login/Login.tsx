...
import { Alert, TextField, Button, CircularProgress, InputAdornment } from "@mui/material";
...
const AALogin: React.FC = () => {
  ...
  const isVerificationParamter = searchUrlForParameters.get("verification_code");
        ...
        {!isVerification ? (
          <>
            {forgotPassword === "true" ? (
              ...
              <div>
                ...
                <div className="image-container">
                  ...
                  <img src={AGENT_MISSION_IMAGES.USER} alt="Second Image" className="buttom-image" />           
                  <img src={MAIN_IMAGES.MAIN_LOGO} alt="First Image" className="top-image" />
                ...
                <TextField
                  ...
                  error={touchedFields.emailAddress && !isValidEmail(values.emailAddress)}
                  helperText={
                    touchedFields.emailAddress && !isValidEmail(values.emailAddress)
                ...
                <TextField
                  ...
                  error={touchedFields.password && !isValidPassword(values.password)}
                  helperText={
                ...
                <Button
                  ...
                  color="primary"
                  onClick={handleLogin}
                  disabled={!isValidEmail(values.emailAddress) || !isValidPassword(values.password) || !verified}
                >
                  Login
                </Button>
              </div>
            ...
            <div className="login-caption">
              <Link to={paths.aaLogin + "?forgot_password=true"}>Forgot password?</Link>
            </div>
          </>
        ) : (
          ""
