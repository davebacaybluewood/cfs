const emailChangePasswordSuccess = (email, id, name) => {
    ...
    >
      ...
      >
        ...
        >
          ...
          <a
            href="https://gocfs.pro/portal/login"
            style="font-family: 'Helvetica', Arial, sans-serif"
            >https://gocfs.pro/portal/login</a
          >
        </div>
        <!-- Start footer -->
        <table
...
export default emailChangePasswordSuccess;
