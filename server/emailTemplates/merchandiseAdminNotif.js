  ...
  return `<!DOCTYPE html
    ...
    <body style="
        ...
        " width="570">
            ...
            padding-bottom: 10px;
            ">
                ${subscriberName} redeemed a merchandise. Please see further details below.
            </p>
            <div style="margin-bottom: 0; padding-bottom: 5px">
                <ul style="font-family: Roboto, sans-serif">
                    <li style="font-size: 13px; margin-bottom: 10px">
                        <b>Subscriber Name:</b> ${subscriberName}
                    </li>
                    <li style="font-size: 13px; margin-bottom: 10px">
                        <b>Date requested:</b> ${formatISODateOnly(
                          dateRequested
                        )}
                    </li>
                    <li style="font-size: 13px; margin-bottom: 10px">
