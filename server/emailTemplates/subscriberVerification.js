const subscriberVerification = (verificationCode) => {
      ...
      >
        ...
        >
          ...
          <div
            ...
            width="570"
          >
            <p style="margin-bottom: 0; padding-bottom: 0px; margin-top: 0">
              For your protection, <b>DO NOT SHARE THIS WITH ANYONE</b>. You are
              registering an account using this email address in our CFS portal. Your Verification Code is
              <span style="border-bottom: 1px solid #333">${verificationCode}</span>.
            </p>
...
export default subscriberVerification;
