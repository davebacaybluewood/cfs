...
const trialRegistrationSuccess = ({ agentId, specialties }) => {
  let isWealthBuilder;
  let isFinancialFreedom;
  if (specialties) {
    isWealthBuilder = specialties.includes(AGENT_SPECIALTIES[0]);
    isFinancialFreedom = specialties.includes(AGENT_SPECIALTIES[1]);
  }
            ...
            <![endif]-->
              ...
              >
                ...
                <tr>
                  ...
                  >
                    <p style="margin: 0">
                      You just took the first step to reach your financial comfort.
                      We hope that this free trial will widen your horizon and let you experience the Advantage and Edge of
                      being with us at
                      CFS.
                    </p>
                    <p>
                      It takes 3-5 business days to process your request.
                    </p>
                    <p>
                      We are excited to welcome you soon into the family.
                      We’ll keep you posted on updates regarding your registration.
                    </p>
                  </td>
                </tr>
                <!-- end copy -->
                ...
                <tr>
                  ...
                  >
                    <p style="margin: 0">
                      You can track your registration status by clicking the button below.
                      <br />
                      <br />
...
export default trialRegistrationSuccess;
